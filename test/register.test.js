...
describe('register and use', function () {
    ...
    describe('組み込みモジュール fs をパスで登録して使う', function () {
        var service;
    ...
    describe('組み込みモジュール fs をインスタンス登録して使う', function () {
        var service;
    ...
    describe('hello を返す関数のパスを登録して使う', function () {
        var service;
    ...
    describe('hello を返す関数のインスタンスを登録して使う', function () {
        var service;

        before(function () {
            con.register('func', {
                module: require("./samples/hello_function")
            });
            service = con.get('func');
        });
    ...
    describe('OK を返す foo 関数を持つオブジェクトのパスを登録して使う', function () {
        var service;
    ...
    describe('OK を返す foo 関数を持つオブジェクトのインスタンスを登録して使う', function () {
        var service;

        before(function () {
            con.register('obj', {
                module: require("./samples/foo_object")
            });
            service = con.get('obj');
        });
